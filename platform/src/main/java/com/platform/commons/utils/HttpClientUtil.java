...
public final class HttpClientUtil {
    ...
    /**
     * httpClient使用实现类的是closeableHTTPClient
     */
...
//                .setBufferSize(4128) // TODO 设置缓冲区大小：默认8k，调整4K
        ...
        RequestConfig defaultRequestConfig = RequestConfig.custom()
                ...
                .setSocketTimeout(30000) // TODO 需要改
...
//                .setDefaultConnectionConfig(connectionConfig)// TODO 设置缓冲区大小：默认8k，调整4K
                .build();
    ...
    public static String post(String url, String content, String charset) {
        return post(url, null, content, null, charset);
    }
    ...
    public static String post(String url, Map<String, String> headers, String content, String cookie, String charset) {
        ...
        try {
            ...
            StatusLine sl = res.getStatusLine();
            if (sl.getStatusCode() == HttpStatus.SC_OK) {
                String rtv = EntityUtils.toString(res.getEntity(), charset);
